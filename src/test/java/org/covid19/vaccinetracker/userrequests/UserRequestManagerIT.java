...
public class UserRequestManagerIT {
    ...
    public void testFetchUserPincodes() throws Exception {
        kafkaTemplate.send(userRequestsTopic, "931543", new UserRequest("931543", asList("110045", "110081"), null, null, null, null)).get();
    ...
    public void testUpdateUserRequestLastNotifiedAt() {
        userRequestManager.updateUserRequestLastNotifiedAt(
                new UserRequest("654321", asList("400026", "431122"), null, null, null, null),
        ...
        records.forEach(record -> {
            if ("654321".equals(record.key())) {
                assertThat(record, hasValue("{\"chatId\":\"654321\",\"pincodes\":[\"400026\",\"431122\"],\"age\":null,\"dose\":null,\"vaccine\":null,\"lastNotifiedAt\":\"2021-05-09T20:51:55.415207+05:30\"}"));
                recordFound.set(true);
            }
        });
        assertTrue(recordFound.get());
    ...
    public void testFetchAllUserRequests() throws Exception {
        kafkaTemplate.send(userRequestsTopic, "456789", new UserRequest("456789", asList("360005", "110085"), null, null, null, null)).get();
        await().atMost(1, SECONDS).until(() -> userRequestManager.fetchAllUserRequests().size() >= 1);
    ...
    public void testFetchAllUserDistricts() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, "999888", new UserRequest("999888", asList("110092", "110093"), null, null, null, null)).get();
    ...
    public void testfetchAllUsersByPincode() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, "112233", new UserRequest("112233", List.of("751010"), null, null, null, null)).get();
        ...
        kafkaTemplate.send(userRequestsTopic, "112234", new UserRequest("112234", List.of("751010"), null, null, null, null)).get();
        ...
        kafkaTemplate.send(userRequestsTopic, "112233", new UserRequest("112233", List.of("847226"), null, null, null, null)).get();
        ...
        kafkaTemplate.send(userRequestsTopic, "112233", new UserRequest("112233", List.of(), null, null, null, null)).get();
    ...
    public void testGetUserAgePreferenceFor18() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("751010"), AGE_18_44.toString(), null, null, null)).get();
    ...
    public void testGetUserAgePreferenceFor45() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("751010"), AGE_45.toString(), null, null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserAgePreferenceForBoth() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("751010"), AGE_BOTH.toString(), null, null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserAgePreferenceWhenNotSet() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("751010"), null, null, null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
        assertThat(userRequestManager.getUserAgePreference(userId), is(equalTo(AGE_18_44)));
    }
    ...
    public void testGetUserDosePreferenceForDose1() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, DOSE_1.toString(), null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserDosePreferenceForDose2() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, DOSE_2.toString(), null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserDosePreferenceForDoseBoth() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, DOSE_BOTH.toString(), null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserDosePreferenceForDoseNotSet() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, null, null, null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
        assertThat(userRequestManager.getUserDosePreference(userId), is(equalTo(DOSE_1)));
    }
    ...
    public void testGetUserVaccinePreferenceForCovishield() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, null, COVISHIELD.toString(), null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserVaccinePreferenceForCovaxin() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, null, COVAXIN.toString(), null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
    ...
    public void testGetUserVaccinePreferenceForSputnikV() throws Exception {
        ...
        kafkaTemplate.send(userRequestsTopic, userId, new UserRequest(userId, List.of("415002"), null, null, SPUTNIK_V.toString(), null)).get();
        await().atMost(1, SECONDS).until(() -> nonNull(userRequestManager.fetchUserRequest(userId)));
