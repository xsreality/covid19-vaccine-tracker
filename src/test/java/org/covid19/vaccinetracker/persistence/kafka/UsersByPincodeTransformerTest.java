...
public class UsersByPincodeTransformerTest {
    ...
    public void shouldFlushStoreForFirstInput() {
        inputTopic.pipeInput("9999", new UserRequest("9999", List.of("110092"), null, null));
    ...
    public void shouldUpdateStoreForSecondUserWithSamePincode() {
        ...
        inputTopic.pipeInput("4567", new UserRequest("4567", List.of("411038"), null, null));
    ...
    public void shouldUpdateStoreWhenUserUpdatesPincode() {
        ...
        inputTopic.pipeInput("1234", new UserRequest("1234", List.of("422104"), null, null));
    ...
    public void shouldUpdateStoreWhenUserRemovesAllPincodes() {
        ...
        inputTopic.pipeInput("1234", new UserRequest("1234", List.of(), null, null));
    ...
    public void shouldUpdateStoreWhenUserSendsMultiplePincodes() {
        ...
        inputTopic.pipeInput("4932", new UserRequest("4932", List.of("682026", "682027"), null, null));
